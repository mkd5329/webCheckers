...
public final class Application {
  ...
  public static void main(String[] args) {
    ...
    // Used to keep track of currently active games in this session
    final CheckersGameService checkersGameService = new CheckersGameService();

    // The one and only PlayerLobby, which gets injected into the web server.
    // Used to keep track of players in the lobby in this session.
    final PlayerLobby playerLobby = new PlayerLobby(checkersGameService);
    ...
    final WebServer webServer = new WebServer(playerLobby, templateEngine, gson, checkersGameService);
